...
#import "ListCell.h" // for speech feature
#import "Listitem.h"// for speech feature


@implementation AppDelegate
@synthesize imageList; // for picture database
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    AuthenticationViewController *viewController1;
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone)
    {
        viewController1 = [[AuthenticationViewController alloc] initWithNibName:@"AuthenticationViewController" bundle:nil];
