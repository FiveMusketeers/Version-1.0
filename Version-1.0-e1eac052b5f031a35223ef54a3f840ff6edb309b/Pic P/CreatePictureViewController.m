...
- (void)viewDidLoad
{
    ...
    */
    testImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Fishy.png"]] ;
...
//    UIImage *theImage=pickenImage.image; // UI image from the iPhone gallery.
    ...
    NSString *sqlCommand = [NSString stringWithFormat:@"INSERT INTO items VALUES ('%@', '%@.png')", textOfImage, textOfImage];
